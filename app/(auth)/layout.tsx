...
export default function AuthLayout({
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden bg-background">
      ...
      {/* Floating orbs - smaller/hidden on mobile to avoid covering forms */}
      <div className="hidden sm:block fixed top-1/4 left-1/4 w-48 sm:w-96 h-48 sm:h-96 bg-violet-500/20 rounded-full blur-3xl animate-float" />
      <div className="hidden sm:block fixed bottom-1/4 right-1/4 w-48 sm:w-96 h-48 sm:h-96 bg-cyan-500/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '1s' }} />
      <div className="hidden md:block fixed top-1/2 right-1/3 w-64 h-64 bg-fuchsia-500/15 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }} />
